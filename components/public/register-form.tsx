...
function validate(form: FormData): Errors {
  ...
  else if (!/^\+?[0-9\s\-]{7,15}$/.test(form.whatsapp))
  ...
  if (!form.password) e.password = "La contraseña es obligatoria.";
    ...
    e.password = "Incluye mayúscula y número.";
    ...
    return (
      <div className="flex flex-col items-center gap-4 py-6 text-center">
        ...
        <Button
          asChild
          size="lg"
          className="w-full bg-[#8B1A8B] hover:bg-[#7a167a] text-white rounded-xl h-11"
        >
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-start gap-2.5">
          ...
          >
            ...
            <Link
              href="/terms"
              className="text-[#8B1A8B] hover:underline font-medium"
            >
      ...
      <p className="text-center text-sm text-gray-500">
        ...
        <Link
          href="/auth/login"
          className="text-[#8B1A8B] font-semibold hover:underline"
        >
          Inicia sesión aquí
        </Link>
      </p>
      ...
      <div className="flex flex-col items-center gap-2 pt-1 border-t border-gray-100">
        ...
        <div className="flex items-center gap-5 text-gray-400">
          <span className="flex items-center gap-1.5 text-xs">
            <ShieldCheck className="size-3.5 text-[#8B1A8B]" />
            Pago Seguro
          </span>
          <span className="flex items-center gap-1.5 text-xs">
            <KeyRound className="size-3.5 text-[#8B1A8B]" />
            Datos Cifrados
          </span>
        </div>
      </div>
