...
const INPUT_CLASS =
  "pl-9 h-11 rounded-xl border-gray-200 placeholder:text-gray-300 focus-visible:border-[#8B1A8B] focus-visible:ring-[#8B1A8B]/20";
      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="text-xs text-[#8B1A8B] hover:underline font-medium"
          >
            ¿La olvidaste?
          </Link>
        </div>
