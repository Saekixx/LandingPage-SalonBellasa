...
export default function LoginPage() {
  return (
    <main className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#fdf4ff] via-[#fce7f3] to-[#f3e8ff] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center gap-2 mb-8">
          ...
          <h1 className="text-lg font-bold text-gray-900 tracking-wide">Aura Beauty</h1>
          <p className="text-[11px] uppercase tracking-widest text-gray-400 font-medium -mt-1">Wellness & Salon</p>
        </div>
