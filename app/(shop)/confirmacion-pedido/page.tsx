...
export default function ConfirmacionPedidoPage() {
  ...
  const totalPago = "125.00";

  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-linear-to-tr from-[#f3e8ff] via-[#faf5ff] to-[#fff5f5] p-4">
      <Card className="w-full max-w-xl rounded-3xl border border-gray-100/50 bg-white p-8 shadow-xl md:p-12">
        <CardContent className="flex flex-col items-center p-0 text-center">
          ...
          <p className="mt-3 max-w-sm text-sm font-medium leading-relaxed text-gray-500">
            Tu pedido ha sido procesado con éxito. Hemos enviado los detalles a
          ...
          <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl bg-[#eff6ff] p-5 text-left">
              ...
              <p className="mt-1 text-sm font-medium text-gray-500">
                <span className="font-bold text-[#2d0b30]">
                  {cantidadProductos} productos
                </span>{" "}
                -{" "}
                <span className="font-extrabold text-[#2d0b30]">
                  S/{totalPago}
                </span>
              </p>
            </div>
          ...
          <div className="mt-8 grid w-full grid-cols-1 gap-4 sm:grid-cols-2">
            <Link href="/productos">
              <Button className="w-full rounded-xl bg-linear-to-r from-[#7a096a] to-[#b30b77] py-6 text-sm font-bold text-white shadow-md transition-all hover:opacity-95 active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2">
